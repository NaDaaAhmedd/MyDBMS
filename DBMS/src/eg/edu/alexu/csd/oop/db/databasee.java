...
import java.util.Vector;
    ...
    public class databasee implements Database {
        ...
        private String[] getNameSelect(String s) {
            s = removeSpaces(s);
        ...
        public String createDatabase(String databaseName, boolean dropIfExists) {
            ...
            try {
                ...
                } else if (y.isDatabaseExist(dataname) && !dropIfExists) {
                    return y.getpathof(dataname);
                } else {
                    counter = 1;
                    ppp = false;
        ...
        public boolean executeStructureQuery(String query) throws SQLException {
            ...
            if (counter == 1) {
                dataname = Name;
                db.setname(Name);
                f.createDatabase(Name);
                return f.isDatabaseExist(Name);
            ...
            if (counter == 3) {
                ...
                return f.isTableExist(Name, dataname);

            }
            if (counter == 4) {
                if (this.db.isTableExists(Name)) {
                    f.dropTable(Name, dataname);
                    return true;
                } else
                    throw new SQLException("invalid");
            } else if (counter == 2) {
            ...
            if (counter == 10 || counter == 11) {
                        ...
                        if (this.db.getTable(ss[0]).ifColumnExists(condition[0])) {
                            ...
                            if (condition[2].contains("'") && condition[1].equals("=")
                                ...
                                if (condition[1].equals("=")) {
                                    ...
                                    f.deleteAndUpdate(db.getTable(ss[0]));
                                    return counterr;
                                } else
                                    return 0;
                            } else
                ...
                if (this.db.isTableExists(ss[1])) {
                    ...
                    if (counter == 9) {
                        ...
                        f.deleteAndUpdate(db.getTable(ss[1]));
